...
from CalculateWeatherAttenuation import getPrecipitationChance as get_weather_atten
import datetime
import pytz
import math
import csv
...
start_date = today - datetime.timedelta(days=240)
with open('energyForecast.csv', 'w', newline='') as energyFile:
    ...
    while start_date <= (today - datetime.timedelta(days=235)):
